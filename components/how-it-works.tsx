...
const steps = [
  ...
  {
    icon: <Cog className="h-8 w-8 text-pink-400" />,
          ...
          <div className="space-y-12 md:space-y-24">
            {steps.map((step, index) => (
              <div
                ...
                } flex-col md:items-center gap-6`}
              >
                <div className="flex-1">
                  <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-purple-500/30 transition-all duration-300">
                    <h3 className="text-xl font-semibold mb-2 text-white flex items-center gap-2">
                      <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-purple-500/20 text-white">
                        {index + 1}
                      </span>
                      {step.title}
                    </h3>
                ...
                <div className="relative flex items-center justify-center md:w-16 w-14 h-14 rounded-full bg-slate-800 border-4 border-slate-700 z-10">
                  {step.icon}
                </div>
